    ...
    <div className='text-white flex w-full justify-between items-start p-10 md:p-20'>
        <div className='md:w-2/4 md:pt-10'>
            ...
            <p className='text-sm md:text-2xl tracking-tight'>I'm a Frontend Developer with a passion for creating clean, user-friendly, 
                and accessible web applications. I specialize in, React, CSS, HTML, Javascript, Bootstrap, jQuery, Responsive Design. I enjoy turning challenges into simple, beautiful, and friendly interfaces. Whether working on a large-scale web application or 
